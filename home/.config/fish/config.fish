...
alias nswitch="sudo nixos-rebuild switch --flake /etc/nixos#pablo-laptop"
alias nswitchu="sudo nix flake update --flake /etc/nixos; and sudo nixos-rebuild switch --flake /etc/nixos#pablo-laptop --upgrade"
